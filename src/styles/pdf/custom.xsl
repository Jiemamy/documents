...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:param name="title.font.family" select="'IPAPGothic'" />
  <xsl:param name="body.font.family" select="'IPAPMincho'" />
  <xsl:param name="sans.font.family" select="'IPAPGothic'" />
  <xsl:param name="monospace.font.family" select="'IPAPMincho'" />
...
<!--###################################################
    ...
    <xsl:param name="qanda.defaultlabel" select="'qanda'"/>
